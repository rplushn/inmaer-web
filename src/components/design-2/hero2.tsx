...
import { Autoplay as SwiperAutoplay, EffectCoverflow, Pagination } from "swiper/modules";
  ...
  return (
    <section className={cn("py-32", className)}>
      ...
      <div className="container mt-4 flex flex-col items-center justify-center gap-4 overflow-hidden text-left xl:mt-14 xl:flex-row xl:overflow-visible">
        ...
        <div className="relative mt-36 h-[580px] w-full xl:mt-0 xl:w-3/5">
            ...
            >
              <CarouselContent className="ml-0">
                {logos.map((logo, index) => (
                  <CarouselItem
                    key={index}
                    className="relative mr-6 flex h-[60px] basis-1/6 justify-center pl-0 opacity-30 xl:mr-12"
                  >
          ...
          <div className="mx-auto flex h-full items-center justify-center">
            {domLoaded && (
              <Swiper
                ...
                modules={[EffectCoverflow, SwiperAutoplay, Pagination]}
          ...
          <div className="absolute top-0 right-0 z-[-1] h-full w-full rounded-3xl bg-muted xl:top-1/2 xl:mt-4 xl:h-[620px] xl:w-[90%] xl:-translate-y-1/2" />
        </div>
      </div>
    </section>
  );
