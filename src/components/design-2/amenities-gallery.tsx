...
const AmenitiesGallery = ({ className }: AmenitiesGalleryProps) => {
  return (
    <section className={cn("py-32", className)}>
      <div className="relative container mx-auto">
        {/* Title Section */}
        <div className="mb-16 text-center">
          <h2 className="text-4xl md:text-[70px] font-semibold uppercase leading-[80px] font-sans text-foreground">
        ...
        <div className="grid grid-cols-5 gap-4">
          <BlurVignette
            ...
            blur="15px"
            className="col-span-2 h-[400px] rounded-none"
          >
            <img
              width={200}
              height={200}
          ...
          <BlurVignette
            ...
            transitionLength="100px"
            blur="15px"
            className="col-span-3 h-[400px] rounded-none"
          >
            <img
              width={200}
              height={200}
          ...
          <BlurVignette
            ...
            transitionLength="100px"
            blur="15px"
            className="col-span-5 h-[550px] rounded-none"
          >
            <img
              width={200}
              height={200}
