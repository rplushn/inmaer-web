  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 -mt-[20px]">
          {/* Left Column - Label */}
          ...
          <div className="md:col-span-10 flex flex-col gap-6 md:gap-8 ml-[135px] justify-start items-start">
            {/* Title */}
            ...
            {/* Paragraph */}
            <p className="text-base text-muted-foreground max-w-xl font-sans leading-relaxed ml-[50px]" style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, sans-serif' }}>
